...
export function generateAuditReport(
  ...
  try {
    ...
    // Title
    doc.setFontSize(20);
    doc.text('Smart Contract Security Audit Report', pageWidth / 2, currentY, { align: 'center' });
    currentY += 15;
    ...
    // Overall Score
    doc.setFontSize(16);
    doc.text('Analysis Scores', 14, currentY);
    currentY += 10;
    ...
    doc.text('Issues Summary', 14, currentY);
